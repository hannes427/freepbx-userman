...
class Openldap2 extends Auth {
 ...
 private ?string $time = null;
	...
	private array $allowLdapProtocolVersion = [2, 3];

	private static array $serverDefaults = ['host' => 'ldap.domain.local', 'port' => '389', 'version' => 3, 'basedn' => 'dc=domain,dc=local', 'username' => 'cn=manager,dc=domain,dc=local', 'password' => '', 'connection' => '', 'localgroups' => 0, 'createextensions' => '', 'externalidattr' => 'entryUUID', 'descriptionattr' => 'description', 'commonnameattr' => 'cn'];
	...
	private static array $userDefaults = [
     ...
     /** Display Name **/
     'usertitleattr' => 'title',
     /** Personal Title TODO: MISS **/
     'usercompanyattr' => 'o',
     /** Company **/
     'userdepartmentattr' => 'ou',
     /** Department **/
	...
	private static array $groupDefaults = [
     'groupdnaddition' => 'ou=Group',
     /** Group DN **/
	...
	*/
	public static function getInfo($userman, $freepbx) {
		...
		return ["name" => _("OpenLDAP Directory")];
	}
